...
showRegisterForm = false;
  ...
  users: User[] = [
    { username: 'Administrator', fullName: 'Administrator', lastActivity: '21/08/2014' },
    { username: 'knowlede.sipho', fullName: 'sipso', lastActivity: '11/07/2022' },
    { username: 'zzz.sdd', fullName: 'sipho zane', lastActivity: '18/03/2014' },
    { username: 'Addd.dddd', fullName: 'zane Aubry', lastActivity: '01/03/2024' },
    { username: 'bghd kn', fullName: 'Getty Thulane', lastActivity: '29/02/2024' }
  ];
 ...
 openRegisterForm() {
  ...
  registerUser() {
    ...
    this.newUser = {
      ...
      surname: '',
      email: '',
      positions: { employee: false, systemAdmin: false }
    };
  }
}
